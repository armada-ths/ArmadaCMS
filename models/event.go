...
type Event struct {
	...
	EventStart           string           `gorm:"column:event_start;not null" json:"eventStart"`
	EventEnd             string           `gorm:"column:event_end;not null" json:"eventEnd"`
	RegistrationEnd      *string          `gorm:"column:registration_end" json:"registrationEnd,omitempty"`
