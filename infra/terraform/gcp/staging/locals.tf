...
locals {
  ...
  secret_env_vars = {
    ...
    PHOTO_TOKEN_SECRET              = "${var.name_prefix}-PHOTO_TOKEN_SECRET"
  }
  ...
  cloud_build_staging_pr_trigger_description = "Build ${var.service_name} container for pull request validation without publishing it"
